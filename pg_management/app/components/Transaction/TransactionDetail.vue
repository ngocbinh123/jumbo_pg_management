<template>
  <GridLayout rows="50,20, auto,30,30, auto, 20,auto,auto,auto, auto, 20, auto,auto,*" columns="50,*,10,50,*" class="page-parent">
    ...
    <Label :text="transaction.code" class="trans-code-value" row="8" col="1" colSpan="4"/>

    <Label :text="'fa-map-marker-alt' | fonticon" class="fas font-icon font-icon-size-18" row="9" col="0" />
    <Label :text="transaction.store" class="trans-code-value" row="9" col="1" colSpan="4" />

    <Label :text="'fa-money-bill-alt' | fonticon" class="far font-icon font-icon-size-18" row="10" col="0" v-show="transaction.transTotal <= 0" />
    <Label :text="transaction.displayTransTotal" class="trans-total-value" row="10" col="1" colSpan="4" v-show="transaction.transTotal <= 0" />

    <GridLayout row="10" col="0" colSpan="5" rows="auto, auto, auto" columns="100, *" class="edt-box" v-show="transaction.transTotal > 0">
