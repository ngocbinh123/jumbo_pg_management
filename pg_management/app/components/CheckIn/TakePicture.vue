<template>
    <Page actionBarHidden="true">
        <GridLayout rows="50,20,*,auto,5,60" columns="50,*,50" class="page-parent">
            ...
            <Label :text="'fa-chevron-left' | fonticon" class="fas btn-back"  @tap="backTo()" row="0" col="0" />
...
export default {
    ...
    methods: {
        backTo() {
            this.$delegate.fetchingDataAfterCheckin();
            this.$navigateBack();
        },
            ...
            return new Promise(resolve => {
                if (platform.isIOS) {
                    ...
                    .then((imageSource) => {
                        ...
                        const fileName = `IMG_PG_MAN_${Date.now()}.png`;
                    ...
                    .catch((e) => {
                        console.log("===> getImageFilePath Error: ");
                        console.log(e);
                    });
                } else {
        ...
        submitData() {
            ...
            .then(response => {
                ...
                this.$delegate.fetchingDataAfterCheckin(true);
                this.$navigateBack();
            })
            .catch(error => {
                this.processing = false;
                this.$delegate.fetchingDataAfterCheckin(false);
