    ...
    <TabView 
      ...
      <TabViewItem title="ORDERS">
        <GridLayout rows="10, 60, *" columns="100, *, 50">
          ...
          <Label v-if="!isProcessing && $store.state.orders.length == 0" text="No orders on a selected date." class="text-center" margin="24" color="red" row="2" col="0" colSpan="3" rowSpan="2" />
      ...
      <TabViewItem title="CUSTOMERS" >
        <GridLayout rows="10, 60, *" columns="10, *, 50">
          ...
          <Label v-if="!isProcessing && $store.state.customers.length == 0" text="No Customer." class="text-center" textWrap="true" margin="24" color="red" row="0" col="0" colSpan="3" rowSpan="3" />
        </GridLayout>
      </TabViewItem>
    </TabView>
